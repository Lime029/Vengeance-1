module GameData
  ...
  GameData::Evolution.register({
    ...
    :parameter     => Integer,
    :level_up_proc => proc { |pkmn, parameter|
      pkmn.form = PBDayNight.getLycanrocForm(time)
      next pkmn.level >= parameter
    }
  })
  ...
  GameData::Evolution.register({
    :id            => :ItemRegionalStone,
    :parameter     => Integer,
    :use_item_proc => proc { |pkmn, parameter, item|
      pkmn.form = parameter
      next item.id == :REGIONALSTONE
    }
  })
  ...
  GameData::Evolution.register({
    ...
    :parameter     => Integer,
    :on_battle_proc => proc { |pkmn, parameter|
      next pkmn.recoil_damage >= parameter
    }
  })
  ...
  GameData::Evolution.register({
    ...
    :parameter     => Integer,
    :on_battle_proc => proc { |pkmn, parameter|
      next pkmn.barb_barrage_uses >= parameter
    }
  })
  ...
  GameData::Evolution.register({
    ...
    :parameter     => Integer,
    :on_battle_proc => proc { |pkmn, parameter|
      next pkmn.psyshield_bash_uses >= parameter
    }
  })