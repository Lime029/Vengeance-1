class PokeBattle_Scene
    ...
    def pbCreateBackdropSprites
      ...
      if time
        ...
        if pbResolveBitmap(sprintf("Graphics/Battlebacks/message")) #pbResolveBitmap(sprintf("Graphics/Battlebacks/"+trialName+"_message"))
      ...
      messageBG  = "Graphics/Battlebacks/message" #"Graphics/Battlebacks/"+messageFilename+"_message"
      # Apply graphics
