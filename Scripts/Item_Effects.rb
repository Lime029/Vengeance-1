...
ItemHandlers::UseText.add(:BICYCLE,proc { |item|
  ...
  Events.onStepTaken += proc {
    if !$game_player.terrain_tag.ice # Shouldn't count down if on ice
      if $PokemonGlobal.repel > 0
      ...
      if $PokemonGlobal.lure > 0
        ...
        if $PokemonGlobal.lure <= 0
          if $PokemonBag.pbHasItem?(:LURE) ||
             $PokemonBag.pbHasItem?(:SUPERLURE) ||
             $PokemonBag.pbHasItem?(:MAXLURE)
            if pbConfirmMessage(_INTL("The lure's effect wore off! Would you like to use another one?"))
              ret = nil
              pbFadeOutIn {
                scene = PokemonBag_Scene.new
                screen = PokemonBagScreen.new(scene,$PokemonBag)
                ret = screen.pbChooseItemScreen(Proc.new { |item|
                  [:LURE, :SUPERLURE, :MAXLURE].include?(item)
                })
              }
              pbUseItem($PokemonBag,ret) if ret
            end
  ...
  ItemHandlers::UseOnPokemon.copy(:POTION,:BERRYJUICE,:POTION1,:BERRYJUICE1)
  ...
  ItemHandlers::UseOnPokemon.add(:COFFEE,proc{|item,pkmn,scene|
     ...
     if pkmn.hp > 0 && pkmn.status == :SLEEP
       pkmn.heal_status
       scene.pbRefresh
  ...
  ItemHandlers::UseOnPokemon.copy(:COFFEE,:COFFEE1)
  
  ItemHandlers::UseOnPokemon.add(:KONIKONIFRIEDCOMBUSKEN,proc{|item,pkmn,scene|
     ret=false
     if pbHPItem(pkmn,50,scene)
       ret=true
     end
     if pkmn.hp > 0 && pkmn.status == :FROZEN
       pkmn.heal_status
       scene.pbRefresh
       scene.pbDisplay(_INTL("{1} thawed out.",pkmn.name))
       ret=true
     end
     next ret
  })
  
  ItemHandlers::UseOnPokemon.copy(:KONIKONIFRIEDCOMBUSKEN,:KONIKONIFRIEDCOMBUSKEN1)
  
  ItemHandlers::UseOnPokemon.add(:FRESHCREAM,proc{|item,pkmn,scene|
     ret=false
     if pbHPItem(pkmn,50,scene)
       ret=true
     end
     if pkmn.hp > 0 && pkmn.status == :BURN
       pkmn.heal_status
       scene.pbRefresh
       scene.pbDisplay(_INTL("{1}'s burn was cured.",pkmn.name))
       ret=true
     end
     next ret
  })
  
  ItemHandlers::UseOnPokemon.copy(:FRESHCREAM,:FRESHCREAM1)
  
  ItemHandlers::UseOnPokemon.add(:BLUEMOONICECREAM,proc{|item,pkmn,scene|
     if pbHPItem(pkmn,200,scene)
       pkmn.changeHappiness("bluemoon")
       next true
     end
     next false
  })
  
  ItemHandlers::UseOnPokemon.copy(:BLUEMOONICECREAM,:BLUEMOONICECREAM1)
  
  ItemHandlers::UseOnPokemon.add(:VANILLAICECREAM,proc{|item,pkmn,scene|
  ...
  ItemHandlers::UseOnPokemon.copy(:VANILLAICECREAM,:VANILLAICECREAM1)
  
  ItemHandlers::UseOnPokemon.add(:CHOCOLATEICECREAM,proc{|item,pkmn,scene|
     if pbHPItem(pkmn,70,scene)
       pkmn.changeHappiness("regicecream")
       next true
     end
     next false
  ...
  ItemHandlers::UseOnPokemon.copy(:CHOCOLATEICECREAM,:CHOCOLATEICECREAM1)
  
  ItemHandlers::UseOnPokemon.add(:STRAWBERRYICECREAM,proc{|item,pokemon,scene|
     if pbHPItem(pkmn,90,scene)
       pkmn.changeHappiness("regicecream")
       next true
     end
     next false
  ...
  ItemHandlers::UseOnPokemon.copy(:STRAWBERRYICECREAM,:STRAWBERRYICECREAM1)
  
  ItemHandlers::UseOnPokemon.add(:BOILEDEGG,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,40,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:BOILEDEGG,:BOILEDEGG1)
  
  ItemHandlers::UseOnPokemon.add(:INSTANTNOODLES,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,80,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:INSTANTNOODLES,:INSTANTNOODLES1)
  
  ItemHandlers::UseOnPokemon.add(:FRIEDFOOD,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,90,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:FRIEDFOOD,:FRIEDFOOD1)
  
  ItemHandlers::UseOnPokemon.add(:KRABBYCAKE,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,110,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:KRABBYCAKE,:KRABBYCAKE1)
  
  ItemHandlers::UseOnPokemon.add(:COCONUTMILK,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,120,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:COCONUTMILK,:COCONUTMILK1)
  
  ItemHandlers::UseOnPokemon.add(:MOOMOOCHEESE,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,130,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:MOOMOOCHEESE,:MOOMOOCHEESE1)
  
  ItemHandlers::UseOnPokemon.add(:PRECOOKEDBURGER,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,140,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:PRECOOKEDBURGER,:PRECOOKEDBURGER1)
  
  ItemHandlers::UseOnPokemon.add(:PACKAGEDCURRY,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,150,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:PACKAGEDCURRY,:PACKAGEDCURRY1)
  
  ItemHandlers::UseOnPokemon.add(:PASTA,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,160,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:PASTA,:PASTA1)
  
  ItemHandlers::UseOnPokemon.add(:SMOKEPOKETAIL,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,170,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:SMOKEPOKETAIL,:SMOKEPOKETAIL1)
  
  ItemHandlers::UseOnPokemon.add(:PEKINGPSYDUCK,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,180,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:PEKINGPSYDUCK,:PEKINGPSYDUCK1)
  
  ItemHandlers::UseOnPokemon.add(:SHARPEDOFINSOUP,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,190,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:SHARPEDOFINSOUP,:SHARPEDOFINSOUP1)
  
  ItemHandlers::UseOnPokemon.add(:GIGANTAMIX,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,200,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:GIGANTAMIX,:GIGANTAMIX1)
  
  ItemHandlers::UseOnPokemon.add(:ORANBERRY,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,10,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:ORANBERRY,:ORANBERRY1,:BRITTLEBONES,:BRITTLEBONES1)
  
  ItemHandlers::UseOnPokemon.add(:SITRUSBERRY,proc { |item,pkmn,scene|
    next pbHPItem(pkmn,pkmn.totalhp/4,scene)
  })
  
  ItemHandlers::UseOnPokemon.copy(:SITRUSBERRY,:SITRUSBERRY1)
  ...
  ItemHandlers::UseOnPokemon.copy(:AWAKENING,:CHESTOBERRY,:BLUEFLUTE,:POKEFLUTE,:AWAKENING1,:CHESTOBERRY1)
  ...
  ItemHandlers::UseOnPokemon.copy(:ANTIDOTE,:PECHABERRY,:ANTIDOTE1,:PECHABERRY1)
  ...
  ItemHandlers::UseOnPokemon.copy(:BURNHEAL,:RAWSTBERRY,:BURNHEAL1,:RAWSTBERRY1)
  ...
  ItemHandlers::UseOnPokemon.copy(:PARALYZEHEAL,:PARLYZHEAL,:CHERIBERRY,:PARALYZEHEAL1,:CHERIBERRY1)
  ...
  ItemHandlers::UseOnPokemon.copy(:ICEHEAL,:ASPEARBERRY,:ICEHEAL1,:ASPEARBERRY1)
  ...
  ItemHandlers::UseOnPokemon.copy(:FULLHEAL,
     ...
     :BIGMALASADA,:LUMBERRY,:PEWTERCRUNCHIES,:LAVACOOKIE1,:OLDGATEAU1,:CASTELIACONE1,:LUMIOSEGALETTE1,
     :SHALOURSABLE1,:LUMBERRY1,:BIGMALASADA1,:PEWTERCRUNCHIES1)
  ...
  ItemHandlers::UseOnPokemon.copy(:FULLRESTORE,:FULLRESTORE1)
  ...
  ItemHandlers::UseOnPokemon.copy(:REVIVE,:REVIVE1)
  ...
  ItemHandlers::UseOnPokemon.copy(:MAXREVIVE,:MAXREVIVE1)
  ...
  ItemHandlers::UseOnPokemon.copy(:ENERGYPOWDER,:ENERGYPOWDER1)
  ...
  ItemHandlers::UseOnPokemon.copy(:ENERGYROOT,:ENERGYROOT1)
  ...
  ItemHandlers::UseOnPokemon.copy(:HEALPOWDER,:HEALPOWDER1)
  ...
  ItemHandlers::UseOnPokemon.copy(:REVIVALHERB,:REVIVALHERB1)
  ...
  ItemHandlers::UseOnPokemon.copy(:ETHER,:LEPPABERRY,:ETHER1,:LEPPABERRY1)
  ...
  ItemHandlers::UseOnPokemon.copy(:MAXETHER,:MAXETHER1)
  ...
  ItemHandlers::UseOnPokemon.copy(:ELIXIR,:ELIXIR1)
  ...
  ItemHandlers::UseOnPokemon.copy(:MAXELIXIR,:MAXELIXIR1)
  ...
  ItemHandlers::UseOnPokemon.add(:RARECANDY,proc { |item,pkmn,scene|
    ...
    if pkmn.level >= Settings::LEVEL_LIMITS[$Trainer.badge_count] || pkmn.shadowPokemon?
