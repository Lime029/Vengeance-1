class PokeBattle_Battler
    ...
    # Creating a battler
    #=============================================================================
    def initialize(btl,idxBattler,fakeBattler=false)
      @battle      = btl
      @index       = idxBattler
      @captured    = false
      @dummy       = false
    ...
    def pbInitEffects(batonPass,fakeBattler=false)
      ...
      if !fakeBattler
        ...
        @battle.eachBattler do |b|   # Other battlers lose their lock-on against self - Jaw Lock
      ...
      @effects[PBEffects::WasteAnger]          = 0
      @effects[PBEffects::NeverMiss]           = false
      @effects[PBEffects::NewTypeRoll]         = true
      @effects[PBEffects::Conversion2Factory]  = false
      @effects[PBEffects::Combustion]          = false
      @effects[PBEffects::SneakAttack]         = true
      @effects[PBEffects::SpyGear]             = 0
      @effects[PBEffects::SeedRevitalization]  = false
      @effects[PBEffects::Performer]           = 0
      @effects[PBEffects::Prickly]             = false
      @effects[PBEffects::TracedMove]          = false
      @effects[PBEffects::AlreadyHitEffect]    = false
      @effects[PBEffects::UsingSubstitute]     = false
      @effects[PBEffects::FairyTaleRoles]      = []
      @effects[PBEffects::HitsTwice]           = 0
      @effects[PBEffects::HauntedScared]       = -1
      if !fakeBattler
        @battle.eachBattler do |b|   # Other battlers no longer scared of self
          b.effects[PBEffects::HauntedScared] = -1 if b.effects[PBEffects::HauntedScared]==@index
        end
      end
      @effects[PBEffects::BewitchedMark]       = false
      @effects[PBEffects::Persistence]         = false
      @effects[PBEffects::VictoryDance]        = false
      @effects[PBEffects::Splinter]            = 0
      @effects[PBEffects::AbilityTypeRedirect] = false
      @effects[PBEffects::Shifu]               = 0
      @effects[PBEffects::PowerTrance]         = false
      @effects[PBEffects::TimeRewind]          = @pokemon.clone
      @effects[PBEffects::Willpower]           = false
    end
