class PokeBattle_Battle
    ...
    def pbCanRun?(idxBattler)
      ...
      return true if battler.abilityActive? && battler.hasActiveAbility?(:RUNAWAY,false,true)
      ...
      eachOtherSideBattler(idxBattler) do |b|
        return false if b.abilityActive? && trappingTargetAbility?(battler,b)
    ...
    def pbRun(idxBattler,duringBattle=false)
      ...
      if !duringBattle
        ...
        if battler.abilityActive?
          ...
          if battler.hasActiveAbility?(:RUNAWAY,false,true)
