class PokeBattle_Battle
  ...
  #    end
    ...
    def pbCanMegaEvolve?(idxBattler)
      ...
      return @megaEvolution[side][owner] == -1 || $fefieldeffect == 32
    end
    ...
    def pbMegaEvolve(idxBattler)
      ...
      trainerName = pbGetOwnerName(idxBattler)
      # Break Illusion
      if battler.hasActiveAbility?(:ILLUSION) && battler.effects[PBEffects::Illusion]
        ...
        pbDisplay(_INTL("{1}'s illusion wore off!",battler.pbThis))
        pbSetSeen(battler)
      end
      # Mega Evolve
      ...
      when 1   # Rayquaza
        ...
        pbCommonAnimation("MegaEvolutionRayquaza",battler)
      else
      ...
      # Trigger ability
      battler.effects[PBEffects::HolyAbilities] = []
    ...
    def pbPrimalReversion(idxBattler)
      ...
      if battler.isSpecies?(:KYOGRE)
        pbCommonAnimation("PrimalReversionKyogre",battler)
      elsif battler.isSpecies?(:GROUDON)
        pbCommonAnimation("PrimalReversionGroudon",battler)
      end
