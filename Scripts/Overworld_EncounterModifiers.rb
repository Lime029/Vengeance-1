...
Events.onWildPokemonCreate += proc { |_sender, e|
  ...
  Events.onWildPokemonCreate+=proc {|sender,e|
     e[0].learn_move($game_variables[49]) if $game_variables[49]>0
     $game_variables[49] = 0
  }
  
  # Hidden abilities for wild events
  Events.onWildPokemonCreate+=proc {|sender,e|
     e[0].ability_index = $game_variables[51] if $game_variables[51]>-1
     $game_variables[51] = -1
  }