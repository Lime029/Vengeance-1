begin
    class PokeBattle_ActiveField
      ...
      def initialize
        ...
        @effects[PBEffects::FEDuration]      = 0
        @effects[PBEffects::VolTopEruption]  = false
        @effects[PBEffects::PrevFECounter]   = -1
        @effects[PBEffects::ConversionField] = false
        @effects[PBEffects::StrikeValue]     = 0
        @defaultWeather  = :None
        @weather         = :None
        @weatherDuration = 0
        @defaultTerrain  = :None
