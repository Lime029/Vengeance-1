      ...
      def update_screen_tone
        ...
        if weather_type == :Sun
          if PBDayNight.isDay?
            ...
            tone_red = ((tone_red + @sun_strength / 2) * 0.8).round
            tone_green = ((tone_green + @sun_strength / 2) * 0.8).round
            tone_blue = ((tone_blue + @sun_strength / 4) * 0.8).round
          else
            fraction = 1
            tone_red = 0
            tone_green = 0
