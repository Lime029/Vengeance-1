...
class PokemonGlobalMetadata
    ...
    attr_accessor :celebiRescueMapId
    attr_accessor :celebiRescueX
    attr_accessor :celebiRescueY
    attr_accessor :celebiRescueDirection
    # Movement history
    ...
    def getRandomBattleMusic
      choices = ["Aaron","Acerola","Aether Foundation","Aevium Protector","Agatha",
                 "Alder","Archie","Avery","Barry","Bertha","Bianca","Blue","Bruno",
                 "Caitlin","Celestial Admin","Celestial Grunt","Celestial Leader",
                 "Champion Reborn","Champion","Colress","Cynthia","Cyrus","Diantha",
                 "Drake","Elite Four Kalos","Elite Octet","Elite Reborn","Ex-Champion",
                 "Flint","Flora","Frontier Brain Hoenn","Frontier Brain Sinnoh","Ghetsis",
                 "Giovanni","Glacia","Gladion","Grimsley","Guzma","Gym Galar","Gym Hoenn",
                 "Gym Johto","Gym Kalos","Gym Kanto","Gym Leader","Gym Reborn","Gym Rejuvenation",
                 "Gym Sinnoh","Gym Unova","Hala","Hau","Hop","Horde","Hugh","Iris",
                 "Island Kahuna","Jessie & James","Kahili","Kalos Chatelaine","Karen",
                 "Klara","Koga","Kukui","Lance","Lear","Legendary","Leon","Lorelei",
                 "Lucian","Lusamine","Lysandre","Marnie","Marshal","Maxie","Molayne",
                 "Mustard","Mysterious Figure","N","Neo Team Plasma","Olivia","Peony",
                 "Phoebe","Player Character","Plumeria","Protagonist Pasio","PWT Final",
                 "Red","Regal Dame","Regal Grunt","Regal Jester","Regal Knight","Regal Leader",
                 "Regal Prince(ss)","Rival Aria","Rival Aurelia","Rival Bede","Rival Brady",
                 "Rival Claudia","Rival Cole","Rival Hoenn","Rival Kalos","Rival Reborn",
                 "Rival Rejuvenation","Rival Severus","roaming","Rorim B","Rose","Shauntal",
                 "Sidney","Silver","Solaris","Sonia","Steven","Subway Boss","Team Flare",
                 "Team Galactic","Team Magma & Aqua","Team Meteor Admin","Team Meteor",
                 "Team Rocket Executive","Team Xen Executive","Team Xen","Trainer 1",
                 "Trainer 2","Trainer 3","Trainer 4","Trainer 5","Trainer 6","Trainer 7",
                 "Trainer Alola","Trainer Galar","Trainer Johto","Trainer Kalos","Trainer Kanto",
                 "Trainer Pasio","Trainer Reborn","Trainer Rejuvenation","Trainer Sinnoh",
                 "Trainer Unova","trainer","Trial Captain","Ultra Beast","Wallace",
                 "Wally","wild","Will","Zinnia"]
      c = choices[rand(choices.length)]
      echo("\nRandom Battle Music: #{c}")
      return "Battle " + c
    end
  end
